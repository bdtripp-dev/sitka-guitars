...
<div class="nextgen-gallery-onboarding-form-step nextgen-gallery-wizard-success nextgen-gallery-onboarding-step-5" id="resources">
		...
		<div class="nextgen-gallery-onboarding-settings-row no-border ">
			<div class="settings-name">
				<h2><?php esc_html_e( 'Congratulations!', 'nextgen-gallery' ); ?><br/>
					<?php esc_html_e( 'Your system is all set up, and you\'re ready to create your first gallery.', 'nextgen-gallery' ); ?>
				</h2>
	...
	<div class="nextgen-gallery-onboarding-wizard-footer">
		...
		<a class="btn btn-transparent" href="<?php echo esc_url( admin_url( '/admin.php?page=imagely-settings' ) ); ?>"><?php esc_html_e( 'Go to settings', 'nextgen-gallery' ); ?></a>
		<a class="btn nextgen-gallery-onboarding-wizard-primary-btn" href="<?php echo esc_url( admin_url( '/admin.php?page=imagely&tab=general' ) ); ?>"><?php esc_html_e( 'Create your first gallery', 'nextgen-gallery' ); ?>&nbsp; →</a>
	</div>
</div>
